...
@section('content')
    ...
    <div class="container" style="max-width:80%; margin-top: 40px;">
        <form action="{{ route('admin.registration.insertRegistration') }}" method="post">
            ...
            <div class="form-check">
             ...
             <button type="submit" class="btn btn-primary" href="{{route('admin.registration.list')}}" >Odoslať</button>
