                                    ...
                                    <tbody>
                                        ...
                                        <th>{{$user=DB::table('users')->where('id',$registration->id_user)->first()->email}}</th>                      
                                            ...
                                            <th>{{ $registration->date_of_departure}}</th>
                                             <th> <center><a class='btn-floating  waves-effect red darken-4' href="{{route('employee\employee.registration.delete',$registration->id)}}"><i class='material-icons'>delete</i></a></center></th>
                                            <th> <center><a class='btn-floating  waves-effect blue darken-4' href="{{route('employee\employee.registration.update',$registration->id)}}"><i class='material-icons'>edit</i></a></center>
                                              </th>
