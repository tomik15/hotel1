...
@section('content')
    ...
    <div class="container" style="width:80%; margin-top: 15px">
        <form action="{{ route('user\user.registration.insertRegistration') }}" method="post">
            ...
            <div class="form-check">
             ...
             <button type="submit" class="btn btn-primary" href="{{route('user\user.registration.list')}}" >Odoslať</button>
