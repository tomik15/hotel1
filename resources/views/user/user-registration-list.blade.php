        ...
        <div class="row">
            ...
            <div class="col-md-11 col-md-offset-2">
                <div class="panel panel-default">
                    <h1 align="center">Zoznam mojich registracii</h1>
                                    ...
                                    <tbody>
                                        ...
                                        <th>{{$user=DB::table('users')->where('id',$registration->id_user)->first()->email}}</th>                                     
                                            ...
                                            <th>{{ $registration->date_of_departure}}</th>
                                             <th> <center><a class='btn-floating  waves-effect red darken-4' href="{{route('user\user.registration.delete',$registration->id)}}"><i class='material-icons'>delete</i></a></center></th>
